...
pub fn up<B: Backend>(f: &mut Frame<B>, app: &App) {
    let chunks = Layout::default()
...
pub fn down<B: Backend>(f: &mut Frame<B>, app: &App) {
    let chunks = Layout::default()
        .direction(tui::layout::Direction::Horizontal)
        .margin(GLOBAL_MARGIN)
        .constraints([Constraint::Percentage(100)].as_ref())
...
pub fn start<B: Backend>(f: &mut Frame<B>, app: &App) {
    let chunks = Layout::default()
        .direction(tui::layout::Direction::Horizontal)
        .margin(GLOBAL_MARGIN)
        .constraints([Constraint::Percentage(100)].as_ref())
...
pub fn stop<B: Backend>(f: &mut Frame<B>, app: &App) {
    let chunks = Layout::default()
        .direction(tui::layout::Direction::Horizontal)
        .margin(GLOBAL_MARGIN)
        .constraints([Constraint::Percentage(100)].as_ref())
